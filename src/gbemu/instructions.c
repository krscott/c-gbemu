...
const Instruction instructions[0x100] = {
    ...
    [0x34] = {"INC (HL)", 1,
              {{0},
               {.uop = INC, .lhs = BUS, .io = READ_HL},
               {.io = WRITE_HL, .end = true}}},
    [0x35] = {"DEC (HL)", 1,
              {{0},
               {.uop = DEC, .lhs = BUS, .io = READ_HL},
               {.io = WRITE_HL, .end = true}}},
    [0x36] = {"LD (HL),u8", 2,
              {{0},
    ...
    [0xCB] = {"[CB]", 2,
              {{0},
               ...
               {.io = READ_HL},
               {.uop = PREFIX_OP_2, .lhs = BUS, .io = WRITE_HL, .end = true}}},
    [0xCC] = {"CALL Z,u16", 3,
              {{0},
               {.uop = LD_R8_R8, .lhs = JP_LO, .rhs = BUS, .io = READ_PC_INC},
               {.uop = LD_R8_R8, .lhs = JP_HI, .rhs = BUS, .io = READ_PC_INC, .cond = COND_Z},
    ...
    [0xD2] = {"JP NC,u16", 3,
              {{0},
               {.uop = LD_R8_R8, .lhs = JP_LO, .rhs = BUS, .io = READ_PC_INC},
               {.uop = LD_R8_R8, .lhs = JP_HI, .rhs = BUS, .io = READ_PC_INC, .cond = COND_NC},
               {.uop = JP, .end = true}}},
    [0xD3] = {"(undefined)", 1,
    ...
    [0xDA] = {"JP C,u16", 3,
              {{0},
               {.uop = LD_R8_R8, .lhs = JP_LO, .rhs = BUS, .io = READ_PC_INC},
               {.uop = LD_R8_R8, .lhs = JP_HI, .rhs = BUS, .io = READ_PC_INC, .cond = COND_C},
               {.uop = JP, .end = true}}},
    [0xDB] = {"(undefined)", 1,
              {{.undefined = true, .end = true}}},
    [0xDC] = {"CALL C,u16", 3,
